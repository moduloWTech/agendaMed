...
export function AddAppointmentModal({ onClose, onSaved, appointment }: AddAppointmentModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-end justify-center sm:items-center sm:p-4 animate-in fade-in duration-300">
      ...
      <div className="relative bg-white w-full max-w-md h-[90vh] sm:h-auto sm:max-h-[90vh] rounded-t-[32px] sm:rounded-[32px] shadow-2xl flex flex-col animate-in slide-in-from-bottom-full sm:slide-in-from-bottom-0 sm:zoom-in-95 duration-300 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 scrollbar-hide">
          <div className="space-y-6">
            ...
            {/* Especialidade */}
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-2">Especialidade / Exame *</label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[#F8FAFC] border-2 border-transparent focus:border-[var(--color-primary)] rounded-[20px] pl-12 pr-4 py-4 text-gray-800 font-medium outline-none transition-all"
                />
              </div>
            </div>
            ...
            {/* Nome do Médico */}
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-2">Médico (Opcional)</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
            ...
            {/* Local */}
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-2">Local (Opcional)</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-extrabold text-red-700">Alerta Intensivo</span>
                  </div>
                  <Toggle checked={intensiveAlerts} onChange={setIntensiveAlerts} />
                </div>
                <p className="text-sm text-red-600/80 font-medium leading-relaxed pr-8">
            ...
            {/* Anotações */}
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-2">Anotações extras</label>
              <div className="relative">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-[#F8FAFC] border-2 border-transparent focus:border-[var(--color-primary)] rounded-[20px] pl-12 pr-4 py-4 text-gray-800 font-medium outline-none transition-all resize-none"
                />
              </div>
            </div>
