  ...
  return (
    <div className="flex flex-col gap-2 px-1">
      ...
      <select 
        ...
        className="w-full bg-[#F8FAFC] border-2 border-transparent hover:border-gray-200 focus:border-[var(--color-primary)] rounded-[20px] px-4 py-3 text-gray-800 text-base outline-none transition-all cursor-pointer"
      >
