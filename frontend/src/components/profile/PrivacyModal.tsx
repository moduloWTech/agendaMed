...
export function PrivacyModal({ onClose }: PrivacyModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4 animate-in fade-in duration-300">
      ...
      {/* Container */}
      <div className="relative w-full max-w-sm bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl rounded-[32px] shadow-2xl p-6 sm:p-8 border border-white dark:border-slate-700 flex flex-col gap-6 animate-in zoom-in-95 duration-300">

        {/* Header */}
        <div className="flex items-center justify-between mb-1">
          <h2 className="text-2xl font-bold text-[var(--color-primary)] dark:text-slate-100">Privacidade</h2>
          <button
            onClick={onClose}
        ...
        <div className="flex flex-col gap-6 overflow-y-auto max-h-[65vh] custom-scrollbar pb-2 pr-1">
          ...
          <section className="flex flex-col gap-3">
            <h3 className="text-sm font-bold text-gray-400 dark:text-slate-500 uppercase tracking-wider px-1">Alterar Senha</h3>
            <Input
              type="password"
          ...
          <section className="flex flex-col gap-3">
            <h3 className="text-sm font-bold text-gray-400 dark:text-slate-500 uppercase tracking-wider px-1 mt-2">Segurança</h3>
            ...
            <div className="flex items-center justify-between bg-white dark:bg-slate-800 p-4 rounded-[20px] shadow-sm border border-gray-100 dark:border-slate-700">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="font-semibold text-gray-800 dark:text-slate-100">Acesso Biométrico</span>
                  <span className="text-[11px] text-gray-400 dark:text-slate-400">Face ID ou Digital</span>
                </div>
              </div>
          ...
          <section className="flex flex-col gap-3 mt-4">
            <div className="bg-red-50/50 dark:bg-red-900/20 p-4 rounded-[24px] border border-red-100 dark:border-red-900/50">
              <div className="flex items-center gap-2 mb-3">
                <ShieldAlert className="w-5 h-5 text-red-500 dark:text-red-400" />
                <h4 className="font-bold text-red-600 dark:text-red-400">Zona de Perigo</h4>
              </div>
