...
export function LoginScreen() {
  return (
    <div className="min-h-screen w-full flex flex-col md:flex-row bg-slate-900 overflow-x-hidden">
      ...
      {/* ============================================================ */}
      {/* 🖥️ DESKTOP & TABLET HERO PANEL (Visible on md:)              */}
      {/* ============================================================ */}
      <div className="hidden md:flex md:w-1/2 lg:w-3/5 bg-gradient-to-br from-slate-950 via-slate-900 to-[#0c243c] text-white p-8 lg:p-14 flex-col justify-between relative overflow-hidden shrink-0">
      ...
      {/* ============================================================ */}
      {/* 📱 / 🖥️ AUTH PANEL (Mobile FullScreen / Desktop Right Column)  */}
      {/* ============================================================ */}
      <div className="w-full md:w-1/2 lg:w-2/5 flex items-center justify-center min-h-screen bg-slate-900 md:bg-slate-950/40 md:backdrop-blur-xl p-0 md:p-8 lg:p-12 relative z-10">
        <LoginForm />
      </div>
